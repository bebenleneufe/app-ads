...
export const AISLES = Object.freeze({
  ...
  FISH: 'Poissonnerie',
  DAIRY: 'Crèmerie & œufs',
  FRESH_DOUGH: 'Pâtes fraîches & boulangerie',
  GROCERY: 'Épicerie',
  FROZEN: 'Surgelés',
  PANTRY: 'Condiments & épices',
});
...
export const PRODUCTS = Object.freeze([
  ...
  defineProduct({ id: 'thon', name: 'Thon au naturel', brand: 'Nixe', aisle: AISLES.FISH, packageLabel: 'boîte 140 g', packageSize: 140, unit: UNITS.GRAM, price: 1.39, shortName: 'thon' }),
  ...
  defineProduct({ id: 'semoule', name: 'Semoule de blé moyenne', aisle: AISLES.GROCERY, packageLabel: 'paquet 1 kg', packageSize: 1000, unit: UNITS.GRAM, price: 1.39, shortName: 'semoule' }),
  defineProduct({ id: 'nouilles', name: 'Nouilles aux œufs', brand: 'Vitasia', aisle: AISLES.GROCERY, packageLabel: 'paquet 250 g', packageSize: 250, unit: UNITS.GRAM, price: 1.29, shortName: 'nouilles' }),
  defineProduct({ id: 'lentilles-corail', name: 'Lentilles corail', aisle: AISLES.GROCERY, packageLabel: 'sachet 500 g', packageSize: 500, unit: UNITS.GRAM, price: 1.69, shortName: 'lentilles corail' }),
  defineProduct({ id: 'lentilles-vertes', name: 'Lentilles vertes', aisle: AISLES.GROCERY, packageLabel: 'sachet 500 g', packageSize: 500, unit: UNITS.GRAM, price: 1.49, shortName: 'lentilles vertes' }),
  defineProduct({ id: 'pois-chiches', name: 'Pois chiches', brand: 'Freshona', aisle: AISLES.GROCERY, packageLabel: 'boîte 400 g (265 g égouttés)', packageSize: 265, unit: UNITS.GRAM, price: 0.79, shortName: 'pois chiches égouttés' }),
  defineProduct({ id: 'haricots-rouges', name: 'Haricots rouges', brand: 'Freshona', aisle: AISLES.GROCERY, packageLabel: 'boîte 400 g (250 g égouttés)', packageSize: 250, unit: UNITS.GRAM, price: 0.79, shortName: 'haricots rouges égouttés' }),
  defineProduct({ id: 'mais', name: 'Maïs doux', brand: 'Freshona', aisle: AISLES.GROCERY, packageLabel: 'boîte 285 g égouttés', packageSize: 285, unit: UNITS.GRAM, price: 0.89, shortName: 'maïs' }),
  defineProduct({ id: 'tomates-concassees', name: 'Tomates concassées', brand: 'Freshona', aisle: AISLES.GROCERY, packageLabel: 'boîte 400 g', packageSize: 400, unit: UNITS.GRAM, price: 0.65, shortName: 'tomates concassées' }),
  defineProduct({ id: 'coulis', name: 'Coulis de tomate', aisle: AISLES.GROCERY, packageLabel: 'brique 500 g', packageSize: 500, unit: UNITS.GRAM, price: 0.79, shortName: 'coulis de tomate' }),
  defineProduct({ id: 'lait-coco', name: 'Lait de coco', brand: 'Vitasia', aisle: AISLES.GROCERY, packageLabel: 'boîte 400 ml', packageSize: 400, unit: UNITS.MILLILITER, price: 1.29, shortName: 'lait de coco' }),
  defineProduct({ id: 'pesto', name: 'Pesto alla genovese', brand: 'Italiamo', aisle: AISLES.GROCERY, packageLabel: 'bocal 190 g', packageSize: 190, unit: UNITS.GRAM, price: 1.59, shortName: 'pesto' }),
  ...
  defineProduct({ id: 'sauce-soja', name: 'Sauce soja', brand: 'Vitasia', aisle: AISLES.PANTRY, packageLabel: 'bouteille 250 ml', packageSize: 250, unit: UNITS.MILLILITER, price: 1.39, shortName: 'sauce soja', isPantryStaple: true }),
