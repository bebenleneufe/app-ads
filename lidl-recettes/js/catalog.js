...
export const PRODUCTS = Object.freeze([
  ...
  defineProduct({ id: 'houmous', name: 'Houmous nature', aisle: AISLES.CHILLED, packageLabel: 'pot 175 g', packageSize: 175, unit: UNITS.GRAM, price: 1.49, shortName: 'houmous' }),
  defineProduct({ id: 'falafels', name: 'Falafels', brand: 'Vemondo', aisle: AISLES.CHILLED, packageLabel: 'barquette 220 g', packageSize: 220, unit: UNITS.GRAM, price: 1.99, shortName: 'falafels' }),
  ...
  defineProduct({ id: 'pain-pita', name: 'Pains pita', aisle: AISLES.BAKERY, packageLabel: 'sachet de 6', packageSize: 6, unit: UNITS.PIECE, price: 1.19, shortName: 'pain pita', pieceNames: ['pain pita', 'pains pita'] }),
  ...
  defineProduct({ id: 'sardines', name: "Sardines à l'huile d'olive", brand: 'Nixe', aisle: AISLES.CANS, packageLabel: 'boîte 135 g (90 g égouttés)', packageSize: 90, unit: UNITS.GRAM, price: 1.09, shortName: 'sardines égouttées' }),
  defineProduct({ id: 'maquereau', name: 'Filets de maquereau à la tomate', brand: 'Nixe', aisle: AISLES.CANS, packageLabel: 'boîte 169 g', packageSize: 169, unit: UNITS.GRAM, price: 1.29, shortName: 'maquereau à la tomate' }),
  ...
  defineProduct({ id: 'brocoli-surgele', name: 'Fleurettes de brocoli', aisle: AISLES.FROZEN, packageLabel: 'sachet 750 g', packageSize: 750, unit: UNITS.GRAM, price: 1.59, shortName: 'brocoli surgelé' }),
